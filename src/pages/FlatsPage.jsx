...
function FlatsPage({ appData, setAppData, notify }) {
  ...
  const handleSubmit = (event) => {
    ...
    const payload = {
      ...
      image: formData.image || 'https://images.unsplash.com/photo-1494526585095-c41746248156?auto=format&fit=crop&w=900&q=80',
      images: formData.images || [formData.image || 'https://images.unsplash.com/photo-1494526585095-c41746248156?auto=format&fit=crop&w=900&q=80'],
    ...
    addActivity(editingId ? 'Flat edited' : 'Flat added', `${payload.title} was ${editingId ? 'updated' : 'added'} to the flat catalog.`);
            ...
            <table>
              ...
              <tbody>
                {filteredProperties.map((property) => (
                  <tr key={property.id}>
                    <td>
                      <img src={property.image || 'https://images.unsplash.com/photo-1494526585095-c41746248156?auto=format&fit=crop&w=300&q=80'} alt={property.title} className="property-thumb" />
                    </td>
                    <td>
        ...
        {selectedProperty && (
          <div className="manage-property-panel">
            ...
            <div className="detail-grid">
              <div><strong>Flat ID:</strong> <span>{selectedProperty.id}</span></div>
